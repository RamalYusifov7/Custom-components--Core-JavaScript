...
// let elementWidth = document
//   .querySelector(".single-product")
//   .getBoundingClientRect().width; // getting the witdh of products wrapper div. Make sure the wrapper div is => overflow-x: auto
// function scrollLeft() {
//   productContainer.scrollLeft -= elementWidth;
// }
// function scrollRight() {
//   productContainer.scrollLeft += elementWidth;
// }
// carouselPrevBtn.onclick = function () {
//   scrollLeft();
// };
// carouselNextBtn.onclick = function () {
//   scrollRight();
// };
// window.setInterval(scrollRight, 5000);
